...
def func(title, titleDict):
	f=open("I:\\6th semester\\Projects and Lab\\Projects\\IR\\Project\\sentimental_analysis\\docs\\"+str(titleDict[title])+".txt", encoding='utf-8')
	t=[f.readline()]
	text=f.readlines()
	doc=[[t,text]]
	return doc
