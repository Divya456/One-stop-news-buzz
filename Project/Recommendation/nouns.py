...
import os, sys
def recom(index):
    f=open("I:\\6th semester\\Projects and Lab\\Projects\\IR\\Project\\sentimental_analysis\\docs\\"+str(index)+".txt","r", encoding='utf-8')
    doc=[]
    lines=f.readlines()
    ...
    index=1
    for doc in final:
        f=open("I:\\6th semester\\Projects and Lab\\Projects\\IR\\Project\\Recommendation\\"+str(index)+".txt","w")
        f.write(doc[0][0])
        f.write("\n\n")
        f.write(doc[1][0])
        f.close()
